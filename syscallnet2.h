...
static const struct sysent syscallent[] = {
	...
	[146] =
	    { 1, 0, SEN(sched_get_priority_max),
	     "sched_get_priority_max" },
	[147] =
	    { 1, 0, SEN(sched_get_priority_min),
	     "sched_get_priority_min" },
	[148] =
	    { 2, 0, SEN(sched_rr_get_interval_time64),
	...
	[254] =
	    { 3, TD | TF, SEN(inotify_add_watch), "inotify_add_watch" },
	...
	[262] =
	    { 4, TD | TF | TFST | TSTA, SEN(newfstatat), "newfstatat" },
	...
	[297] =
	    { 4, TP | TS, SEN(rt_tgsigqueueinfo), "rt_tgsigqueueinfo" },
	...
	[303] =
	    { 5, TD | TF, SEN(name_to_handle_at), "name_to_handle_at" },
	...
	[322] =
	    { 5, TD | TF | TP | TSD | SE | SI, SEN(execveat), "execveat" },
