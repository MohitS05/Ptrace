...
static inline void list_init(struct list_item *l)
{
	l->prev = l;
	l->next = l;
}
...
static inline bool list_is_empty(const struct list_item *l)
{
 ...
 */
static inline bool list_remove(struct list_item *item)
{
 ...
 */
static inline struct list_item *list_remove_tail(struct list_item *head)
{
 ...
 *             or NULL, if the list is empty.
 */
static inline struct list_item *list_remove_head(struct list_item *head)
{
